...
Linearize[xA_Association, xReferenceMotion_: {}] := 
	SApply[((Series[(((# /. LinearExpansion[xE]) /. xReferenceMotion) /. {Superscript[xX_,\[EmptySmallCircle]]-> 0}),
		{xE,0,1}] // Normal) /. {xE-> 1})&, xA]
(* 	Association[
		"Matrix"-> (Series[(((xA["Matrix"] /. LinearExpansion[xE]) /. xReferenceMotion) /. 
